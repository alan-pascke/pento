defmodule Pento.Catalog do
  ...
  @doc """
  Markdown the product.

  ## Examples

      iex> markdown_product(%Product{}, value_to_subtract)
      {:ok, %Product{}}
  """

  def markdown_product(%Product{} = product, value_to_subtract) do
    product
    |> Product.decrease_unit_price(value_to_subtract)
    |> Repo.update()
  end
