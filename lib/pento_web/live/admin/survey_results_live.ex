defmodule PentoWeb.Admin.SurveyResultsLive do
  ...
  def assign_products_with_average_ratings(
        %{assigns: %{gender_group_filter: gender_group_filter}} =
          socket
      ) do
    assign(
      socket,
      :products_with_average_ratings,
      get_products_with_average_ratings(%{gender_group_filter: gender_group_filter})
    )
  end
  ...
  def assign_dataset(socket) do
    socket
    |> assign(:dataset, make_bar_chart_dataset([]))
  end
